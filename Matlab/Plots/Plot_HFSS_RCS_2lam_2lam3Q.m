...
f02 = 'E0P2T0_2lam_2lam3Q_polPhTh.csv';
...
a = E0P1T0.data(:,1);
% center
E0P1T0_p0       = E0P1T0.data(:,2);
E0P1T0_p90      = E0P1T0.data(:,3);
E0P1T0_polP_p0  = E0P1T0_pol.data(:,2);
E0P1T0_polP_p90 = E0P1T0_pol.data(:,3);
E0P1T0_polT_p0  = E0P1T0_pol.data(:,4);
E0P1T0_polT_p90 = E0P1T0_pol.data(:,5);
% flip v
E0P1T0_FV_p0       = E0P1T0_FV.data(:,2);
E0P1T0_FV_p90      = E0P1T0_FV.data(:,3);
E0P1T0_FV_polP_p0  = E0P1T0_FV_pol.data(:,2);
E0P1T0_FV_polP_p90 = E0P1T0_FV_pol.data(:,3);
E0P1T0_FV_polT_p0  = E0P1T0_FV_pol.data(:,4);
E0P1T0_FV_polT_p90 = E0P1T0_FV_pol.data(:,5);
% flip v right
E0P1T0_VR_p0       = E0P1T0_VR.data(:,2);
E0P1T0_VR_p90      = E0P1T0_VR.data(:,3);
E0P1T0_VR_polP_p0  = E0P1T0_VR_pol.data(:,2);
E0P1T0_VR_polP_p90 = E0P1T0_VR_pol.data(:,3);
E0P1T0_VR_polT_p0  = E0P1T0_VR_pol.data(:,4);
E0P1T0_VR_polT_p90 = E0P1T0_VR_pol.data(:,5);
% center top 
E0P1T0_TopH_p0       = E0P1T0_TopH.data(:,2);
E0P1T0_TopH_p90      = E0P1T0_TopH.data(:,3);
E0P1T0_TopH_polP_p0  = E0P1T0_TopH_pol.data(:,2);
E0P1T0_TopH_polP_p90 = E0P1T0_TopH_pol.data(:,3);
E0P1T0_TopH_polT_p0  = E0P1T0_TopH_pol.data(:,4);
E0P1T0_TopH_polT_p90 = E0P1T0_TopH_pol.data(:,5);
%}
%% plots
tck=0.15;
% P0T1
