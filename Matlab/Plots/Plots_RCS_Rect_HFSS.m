...
% total RCS
figure(1)
H = mmpolar(a,tLam3Q_p0,a,tLam3Qv_p0,a,tLam45_p0,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',tck,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b'); 
...
title({
['Monostatic RCS: 2 \lambda by 2.75 \lambda \phi:0^\circ'] 
[' ']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
figure(2)
...
% title('Monostatic RCS: 2 \lambda by 2 \lambda \phi:90^\circ');
title({
['Monostatic RCS: 2 \lambda by 2.75 \lambda \phi:90^\circ'] 
[' ']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
set(H(3),'color','k'); set(H(3),'LineStyle','-');
...
%% pol: phi
figure(3)
H = mmpolar(a,tLam3Q_p0_ph,a,tLam3Qv_p0_ph,a,tLam45_p0_ph,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',tck,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
% title('Monostatic RCS: 2 \lambda by 2 \lambda  pol:\phi \phi:0^\circ');
title({
['Monostatic RCS: 2 \lambda by 2.75 \lambda  pol:\phi \phi:0^\circ'] 
[' ']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
set(H(3),'color','k'); set(H(3),'LineStyle','-');
...
figure(4)
H = mmpolar(a,tLam3Q_p90_ph,a,tLam3Qv_p90_ph,a,tLam45_p90_ph,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',tck,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
% title('Monostatic RCS: 2 \lambda by 2 \lambda  pol:\phi \phi:90^\circ');
title({
['Monostatic RCS: 2 \lambda by 2.75 \lambda  pol:\phi \phi:90^\circ'] 
[' ']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
set(H(3),'color','k'); set(H(3),'LineStyle','-');
...
%% pol: theta
figure(5)
H = mmpolar(a,tLam3Q_p0_th,a,tLam3Qv_p0_th,a,tLam45_p0_th,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',tck,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
% title('Monostatic RCS: 2 \lambda by 2 \lambda  pol:\theta \phi:0^\circ');
title({ 
['Monostatic RCS: 2 \lambda by 2.75 \lambda  pol:\theta \phi:0^\circ']
['']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
set(H(3),'color','k'); set(H(3),'LineStyle','-');
...
figure(6)
H = mmpolar(a,tLam3Q_p90_th,a,tLam3Qv_p90_th,a,tLam45_p90_th,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',tck,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
% title('Monostatic RCS: 2 \lambda by 2 \lambda  pol:\theta \phi:90^\circ');
title({
['Monostatic RCS: 2 \lambda by 2.7 \lambda  pol:\theta \phi:90^\circ'] 
[' ']});
% legend({'pos:horizontal','pos:vertical'},'Location','northwest');
legend({'pos:horizontal','pos:vertical','pos:45^\circ'},'Location','northwest');
set(H(3),'color','k'); set(H(3),'LineStyle','-');
