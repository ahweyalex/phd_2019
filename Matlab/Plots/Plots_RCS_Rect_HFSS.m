...
% total RCS
figure(1)
H = mmpolar(a,tLam_p0,a,tLamv_p0,...
...
% pol: phi
figure(3)
H = mmpolar(a,tLam_p0_ph,a,tLamv_p0_ph,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',0.05,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
legend({'pos:horizontal','pos:vertical'},'Location','northwest');
figure(4)
H = mmpolar(a,tLam_p90_ph,a,tLamv_p90_ph,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',0.05,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
% pol: theta
figure(5)
H = mmpolar(a,tLam_p0_th,a,tLamv_p0_th,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',0.05,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
...
legend({'pos:horizontal','pos:vertical'},'Location','northwest');
figure(6)
H = mmpolar(a,tLam_p90_th,a,tLamv_p90_th,...
    'Style','compass','TGridVisible','off',...
    'TTickOffset',0.05,'TTickDelta',30);
set(H,'LineWidth',3);
set(H(1),'color','r'); set(H(2),'color','b');
